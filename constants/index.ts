  ...
  job: [
    {
      ...
      name: "All Generation Tech — Alpha FMC (American Equity Life)",
      icon: "agt.png",
      iconBg: "#E6DEDD",
      date: "Jul 2024 - Present",
      points: [
        "Building the full-lifecycle **annuity new business platform** American Equity Life runs on **Unqork**, delivered in sprints with Alpha FMC's US teams and presented at **Unqork Create 2026**.",
        "Wrote **EZ Suit**, the pre-suitability engine scoring assets, income, expenses, and existing annuities against eligibility, premium range, and replacement rules before an application starts.",
        "**MyApp** replaced their legacy **ReadyApp** e-application and runs on a **suitability rules engine** I built, automating pass/pend/fail decisioning with a manual review queue and syncing status to American Equity's **ODS**.",
        "Wired **PandaDoc** in for eSignature end to end, and built the pipelines normalizing **DTCC** fixed-position files, **Firelight** XML, and scanned paper into one data model. **Ignite**, the reps' CRM, covers NIGO resolution, GIACT validation, and **TX103** generation.",
        "Designed the **14-service architecture** underneath, standardizing routing and token caching to cut API round-trips. Agents sign in through **Okta** (OIDC), internal reps through **Azure AD** (SAML), across five personas.",
      ],
    },
    {
      title: "AI Engineer",
      name: "All Generation Tech — Ink'd",
      icon: "agt.png",
      iconBg: "#E6DEDD",
      date: "Dec 2025 - Feb 2026",
      points: [
        "Built a headless **voice AI agent** in **Python** that walks real estate brokers through contract intake by phone, orchestrated as a **LangGraph** state machine over **LiveKit** with Deepgram STT and Cartesia TTS.",
        "The graph validates property and party data field by field, decides which addenda apply, renders and merges PDFs from **S3** templates, then posts the contract to a **Django REST** backend fronted by **Next.js**.",
        "Answer extraction runs through an **LLM** client over **OpenRouter** against declarative field definitions, so a new contract type needs no new prompt code.",
        "Owned the **evaluation loop** in **Python**, replaying conversations through the graph headlessly and reading **LangSmith** and **OpenTelemetry** traces to catch where the agent misread callers before release.",
      ],
    },
    {
      title: "Team Lead",
      ...
      date: "Jul 2024 - Present",
      points: [
        "Lead a team of **7 engineers** staffed across concurrent **Alpha FMC** projects, from allocation through delivery oversight and escalation.",
        "Built the internal **workforce management platform** AllGenTech runs on (**Next.js**, **React**, **TypeScript**, **MongoDB**), covering time & attendance, overtime approvals, and payroll exports.",
        "Staffing dashboards feed a weekly **Slack** report on a cron; tickets sync both ways through the **Jira REST API**.",
        "Separately, architected a **multitenant medical and care center management system** on **Next.js** and **PostgreSQL**, and handled the **Next.js 16**, **React 19**, and **Tailwind v4** migrations while mentoring the team through **code review**.",
      ],
    },
    {
      ...
      points: [
        "Shipped production web applications for international clients on **Next.js**, **Laravel**, and WordPress, owning each engagement from the first scoping call through post-launch support.",
        "Rebuilt corporate marketing sites around **Core Web Vitals** and accessibility.",
        "Designed custom **REST APIs** and refactored the backend logic behind them to hold up under load.",
        "Took over legacy codebases and cleared defects without taking live sites offline.",
        "Standardized deployment and environment provisioning so parallel engagements did not each need a bespoke setup.",
      ],
    },
    {
      ...
      points: [
        "Built WordPress admin dashboards with **ACF**, **UiPress**, and custom hooks, shaped around how each client actually worked.",
        "Kept components modular so widgets could be restyled to a client's branding without a rewrite.",
        "Cut dashboard load times by tracking down UX bottlenecks and backend defects.",
      ],
    },
    {
      title: "Self-Employed",
      ...
      points: [
        "Ran my own **SEO**-driven WordPress properties and wrote the tooling that automated publishing.",
        "Self-managed the hosting on **AWS EC2** and **Lightsail**, including web server, TLS, and backup configuration.",
        "Automated content scraping and deployment with **Selenium** and the **WordPress REST API**.",
      ],
    },
  ],
} as const;
